...
AGENT_ID = "agent-bd0d5ebe-49cb-4962-a812-b5199054c1f0"
...
resp = requests.patch(
    ...
    json={"system": system_prompt, "description": "教育学习记忆智能体 - 负责分析用户学习对话，维护用户画像、知识点理解和学习轨迹记忆。"},
    headers={"Content-Type": "application/json; charset=utf-8"}
)
print(f"Agent update: {resp.status_code}")

# 2. 更新 Learning Memory
learning_memory = """# 学习轨迹 - 按教材分组，每本教材最多5条
...
resp = requests.patch(
    f"{LETTA_BASE_URL}/v1/blocks/block-9c0c9cce-7acd-4b08-97e2-e6738f28feb5",
    json={"value": learning_memory},
    headers={"Content-Type": "application/json; charset=utf-8"}
)
print(f"Learning Memory update: {resp.status_code}")

# 3. 更新 Understanding Memory
understanding_memory = """# 知识点理解 - 一个知识点一条记录
...
resp = requests.patch(
    f"{LETTA_BASE_URL}/v1/blocks/block-91008d87-e480-4db4-8f83-f148d631d54d",
    json={"value": understanding_memory},
    headers={"Content-Type": "application/json; charset=utf-8"}
)
print(f"Understanding Memory update: {resp.status_code}")
